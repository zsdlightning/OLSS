...
test=../../../data/news20/news20.binary.shuf.vw.validation
...
echo $version",alpha="$ftrl_alpha",beta="$ftrl_beta,"auc="$auc
echo $version",alpha="$ftrl_alpha",beta="$ftrl_beta,"auc="$auc >> $res
